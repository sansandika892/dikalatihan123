...

{
   ...
   
    {
        ...
        user::create([
        'name'=>"asia farm",
        'email'=>"Asia Farm Pekanbaru bisa menjadi pilihan destinasi wisata untuk kamu yang suka dengan suasana estetis serta unik",
        ''=>"Jl. Badak Ujung, Bencah Lesung, Kec. Tenayan Raya, Kota Pekanbaru, Riau",
        ]);
