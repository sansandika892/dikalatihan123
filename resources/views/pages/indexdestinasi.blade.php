...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a class ="btn btn-primary" href="/destinations/create" class="btn btn success"><button>Add Destinations </button></a>
    </div>
                ...
                @foreach ($destinations as $d)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/destinations/{{ $d->id }}/delete"method="post" style="display;inline;">
                                @csrf
                                @method ('DELETE')
